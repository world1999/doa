        ...
        for snr in test_snr:
            ...
            if commands["CREATE_DATA"]:
                ...
                if create_testing_data:
                    ...
                    angle1 = np.arange(14.05, -3.95, -0.12)  # 从 14 开始，间隔 -0.01，直到 11.00
                    angle1 = np.round(angle1, 2)  # 保留两位小数
                    # 生成第二个角度：固定间隔为 -5 度
                    angle2 = angle1 - 10  # 每个值减去 5 度
            ...
            if commands["TRAIN_MODEL"]:
                ...
                simulation_parameters = (
                    ...
                    .set_optimizer(optimizer="Adam", learning_rate=0.00001, weight_decay=1e-9)#learning_rate=0.00001, weight_decay=1e-9
